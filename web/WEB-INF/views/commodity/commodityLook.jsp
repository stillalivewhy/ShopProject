    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="addCommodity.do" method="post">
                    <div class="form-group">
                        <label for="commodityNameAdd" class="col-sm-2 control-label">商品名称</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="commodityNameAdd"   placeholder="商品名称" name="commodityNameAdd">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="commodityPriceAdd" class="col-sm-2 control-label">商品价格</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="commodityPriceAdd" placeholder="商品价格" name="commodityPriceAdd">
                        </div>
                    </div>
                ...
                <tbody id="comData">
                    <c:forEach var="item" items="${commodities}" >
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" id="update" onclick="update(this)" data-no="${item.commodityNo}" data-name="${item.commodityName}" data-price="${item.commodityPrice}">
                                    <span class="glyphicon glyphicon-edit"></span>
                                </button>
                                <button class="btn btn-info" onclick="showView(this)"  data-no="${item.commodityNo}" data-name="${item.commodityName}" data-price="${item.commodityPrice}">
                                    <span class="glyphicon glyphicon-text-width"></span>
                                </button>
                                <button class="btn btn-danger" onclick="deleteCom(this)" id="${item.commodityNo}" >
